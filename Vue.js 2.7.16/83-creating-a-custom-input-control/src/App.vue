    ...
    <form>
      ...
      <div class="row">
        <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
          <div class="form-group">
            <label for="sendmail">
              <input type="checkbox" id="sendmail" value="SendMail" v-model="userData.mailOptions"> Send Mail
            </label>
      ...
      <div class="row">
        <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 from-group">
          <app-switch v-model="userData.dataSwitched"></app-switch>
        </div>
      </div>
      <div class="row">
        <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 from-group">
      ...
      <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            ...
            <ul>
              <li v-for="item in userData.mailOptions" :key="item">{{item}}</li>
            </ul>
            <p>Gender: {{userData.gender}}</p>
            <p>Priority: {{userData.selectedPriority}}</p>
            <p>Switched: {{userData.dataSwitched}}</p>
          </div>
        </div>
      </div>
    </div>
